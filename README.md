...
You can install Filesmonster addon using by 2 diferent ways, choose the one that you prefer acording your circunstances (in every way auto-update of this addon ins enabled by default):
